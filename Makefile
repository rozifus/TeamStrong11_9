#fake Makefile for teamstrong11_9, to support the common
...
clean:
	...
	rm -f teamstrong11_9/*~
	rm -rf bin develop-eggs eggs parts .installed.cfg teamstrong11_9.egg-info
