...
PACKAGEDATA = {
    ...
    'package_dir': {'teamstrong11_9': 'teamstrong11_9',
                   },
    'packages': ['teamstrong11_9',
                ],
    'scripts': ['scripts/teamstrong11_9'],
}
...
_DATA_DIR = os.path.join('teamstrong11_9', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'teamstrong11_9': data_dirs}
...
src = []
add_files(src,os.walk('teamstrong11_9'))
